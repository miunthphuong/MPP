	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt){
			try {
				...
				JOptionPane.showMessageDialog(BookWindow.this, "Rules passed! Info Updated.");
			} catch (RuleException e) {
				JOptionPane.showMessageDialog(BookWindow.this, e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
			}
		}
	}
