...
public class Main {
	...
	private void showAllOrderItems() {
		System.out.println("\n==============\nAll order items:");
		//implement
		orders.stream()                            // 1. Create a Stream<Order>
				.flatMap(order -> order.getOrderItems().stream()) // 2. Flatten List<OrderItem> into Stream<OrderItem>
				.forEach(System.out::println);           // 3. Print each OrderItem
	}
